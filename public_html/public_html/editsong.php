<?php
    ...
    if(isset($_GET['songTitle']) && isset($_GET['albumName']) && isset($_GET['artistID'])) {
        ...
        $query = "SELECT * FROM song s WHERE s.name='" . $songTitle . "' AND s.title='" . $albumName . 
...
<div class="container">
    ...
    <div class="row" style="margin-top:30px">
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
          <form role="form" method="post" action="adminsonglist.php">
            <fieldset>
              <h2>Edit song</h2>
              <hr class="colorgraph">
                <div class="form-group">
                    <label for="songtitle" style="color:white">Song Title</label>
                    <?php
                        echo "<input type=\"text\" name=\"songtitle\" id=\"songtitle\" class=\"form-control input-lg\" value=\"" . 
                                $row['name'] . "\">";
                    ?>
                </div>
                <div class="form-group">
                    <label for="albumtitle" style="color:white">Album Title</label>
                    <?php
                ...
                <div class="form-group">
                    <label for="composer" style="color:white">Composer</label>
                    <?php
                        echo "<input type=\"text\" name=\"composer\" id=\"composer\" class=\"form-control input-lg\" value=\"" .
                                $row['composer'] . "\">";
                    ?>
                </div>
                <div class="form-group">
                    ...
                    <?php
                        echo "<input type=\"text\" name=\"genre\" id=\"genre\" class=\"form-control input-lg\" value=\"" .
                                $row['genre'] . "\">";
                    ?>
                </div>
                 <div class="form-group">
                     <label for="length" style="color:white">Song Length (in seconds)</label>
                     <?php
                        echo "<input type=\"text\" name=\"length\" id=\"length\" class=\"form-control input-lg\" value=\"" . 
                            $row['length'] . "\">";
                    ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <?php
                        ...
                        echo "<input type=\"hidden\" name=\"oldsongtitle\" id=\"oldsongtitle\" value=\"" . 
                                $row['name'] . "\">";
